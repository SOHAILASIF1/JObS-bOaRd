...
const Navbar = ({ role = null }: NavbarProps) => {
  ...
  const candidateLinks = (
    <>
      ...
      <Link href="/applications" className="hover:text-amber-400 transition-colors">
       ...
       <Link href="/dashboard/candidate" className="hover:text-amber-400 transition-colors">
        Dashboard
      </Link>
      <button
  ...
  const employerLinks = (
    <>
      <Link href="/dashboard/employer/post-job" className="hover:text-amber-400 transition-colors">
        Post a Job
      </Link>
